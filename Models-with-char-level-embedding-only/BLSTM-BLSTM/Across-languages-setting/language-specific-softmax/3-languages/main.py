...
tag_classify_model = models.get_tag_classify_model(tag_classify_network_cell, max_sentence_length, 2*char_feature_output, hidden_size, no_of_classes_1, no_of_classes_2, no_of_classes_3)
