...
class Load_data:
    ...
    def load_class_annotation_from_train_data(self):
        Preprocessing = preprocessing.Preprocessing(self.train_file, self.max_word_length)
        label_dictionary = Preprocessing.generate_class_annotation(self.divide_file_factor)
        ...
        for i in label_dictionary:
            train_data_class_annotation = self.read_parts_from_file(class_annotation_file_substring + '_' + i, len(label_dictionary[i]))
            train_data_class_annotation_array.append(train_data_class_annotation)
        return train_data_class_annotation_array, label_dictionary
