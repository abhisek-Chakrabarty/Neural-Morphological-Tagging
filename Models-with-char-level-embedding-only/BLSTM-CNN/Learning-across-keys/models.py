...
def get_tag_classify_model_with_CNN(word_context_length, char_feature_output, no_of_kernels, filter_window_length, tag_classes_array):
    ...
    for i in range(0, len(tag_classes_array)):
        main_loss1 = TimeDistributed(Dense(tag_classes_array[i], activation='softplus'))(conv_layer)
