...
class Load_data:
    ...
    def load_class_annotation_from_train_data(self):
        Preprocessing = preprocessing.Preprocessing(self.train_file, self.max_word_length)
        no_of_classes_1, no_of_classes_2 = Preprocessing.generate_class_annotation(self.divide_file_factor)
        ...
        return train_data_class_annotation_1, train_data_class_annotation_2
