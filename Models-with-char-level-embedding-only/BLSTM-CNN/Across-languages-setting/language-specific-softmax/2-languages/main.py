...
tag_classify_model = models.get_tag_classify_model_with_CNN(max_sentence_length+2*filter_window_length, 2*char_feature_output, no_of_kernels, filter_window_length, no_of_classes_1, no_of_classes_2)
