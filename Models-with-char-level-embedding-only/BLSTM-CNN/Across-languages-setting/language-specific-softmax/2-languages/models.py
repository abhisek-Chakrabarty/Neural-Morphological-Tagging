...
def get_tag_classify_model_with_CNN(word_context_length, char_feature_output, no_of_kernels, filter_window_length, tag_classes1, tag_classes2):
    ...
    model = Model(input=[char_vector_input], output=[main_loss1, main_loss2])
    return model
